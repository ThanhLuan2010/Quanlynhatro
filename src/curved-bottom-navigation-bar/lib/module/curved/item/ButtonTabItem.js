...
import Animated, { useDerivedValue, useAnimatedStyle, useAnimatedReaction, useSharedValue } from 'react-native-reanimated';
...
const ButtonTabItemComponent = props => {
  ...
  const scale = useInterpolate(progress, [0, 1], [1, 0.5]); // func
  ...
  useAnimatedReaction(() => isActive.value === index, (result, prevValue) => {
    if (result !== prevValue) {
  ...
  return /*#__PURE__*/React.createElement(TouchableOpacity, {
    ...
    style: [styles.buttonTab, buttonTab]
  }, /*#__PURE__*/React.createElement(Animated.View, {
    style: [containerIconStyle]
  }, renderIcon(), titleShown ? showTitle() : null)));
};

export const ButtonTab = /*#__PURE__*/memo(ButtonTabItemComponent, isEqual);
