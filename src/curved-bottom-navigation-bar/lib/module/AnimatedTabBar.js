...
import { DEFAULT_ITEM_ANIMATION_DURATION, SIZE_DOT, TAB_BAR_COLOR, TAB_BAR_HEIGHT } from './curved/constant';
...
const AnimatedTabBarComponent = props => {
  ...
  const selectedIndex = useSharedValue(0); // callbacks
...
export const AnimatedTabBar = /*#__PURE__*/memo(AnimatedTabBarComponent, isEqual);
