...
const CurvedTabBarComponent = (props: TabBarViewProps) => {
  ...
  const pathProps = useAnimatedProps<PathProps>(() => {
    ...
    return {
      d: `M0,0 L${centerHoleX - SIZE_DOT *0},0
  C${centerHoleX - SIZE_DOT * 0},0 ${centerHoleX - SIZE_DOT +400},${
        HEIGHT_HOLE + 6
      } ${centerHoleX},${HEIGHT_HOLE + 11} 
  C${centerHoleX + SIZE_DOT * 0},${HEIGHT_HOLE + 8} ${
        centerHoleX + SIZE_DOT * 0.1
      },0 ${centerHoleX + SIZE_DOT * 0} 0 
  ...
  `,
    ...
    // return {
    //   d: `M0,0 L${centerHoleX - SIZE_DOT * 0.4},0
    //   C${centerHoleX - SIZE_DOT * 0.56},0 ${
    //     centerHoleX - SIZE_DOT+13 * 1.6
    //   },${HEIGHT_HOLE +16} ${centerHoleX},${HEIGHT_HOLE+21}
    //   C${centerHoleX + SIZE_DOT * 0.75},${HEIGHT_HOLE+15} ${
    //     centerHoleX + SIZE_DOT * 0.55
    //   },0 ${centerHoleX + SIZE_DOT * 0.4} 0
    //   L${actualBarWidth * 2},0 L ${
    //     actualBarWidth * 2
    //   },${actualBarHeight} L 0,${actualBarHeight} Z
    //   `,
